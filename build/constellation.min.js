...
Graph.prototype.Ga=function(a,b){var c=this.q(a);c?c.data=b:h("Failed to update edge. Edge does not exist.");return c};Graph.prototype.updateEdge=Graph.prototype.Ga;Graph.prototype.Ia=function(a,b,c,d,e,f){var e=4<arguments.length?e:n,f=5<arguments.length?f:n,g=this.q(a);g?g.data=e?jQuery.extend(f,g.data,d):d:g=this.D(a,b,c,d);return g};Graph.prototype.upsertEdge=Graph.prototype.Ia;GraphLoader=function(a){0>=arguments.length||(this.config=a,this.parser=this.constellation=l)};window.GraphLoader=GraphLoader;
GraphLoader.prototype.V=q("constellation");GraphLoader.prototype.getConstellation=GraphLoader.prototype.V;GraphLoader.prototype.h=function(a){this.constellation=a};GraphLoader.prototype.setConstellation=GraphLoader.prototype.h;GraphLoader.prototype.ob=q("parser");GraphLoader.prototype.getParser=GraphLoader.prototype.ob;GraphLoader.prototype.vb=function(a){this.parser=a};GraphLoader.prototype.setParser=GraphLoader.prototype.vb;
SimpleGraphLoader=function(a){0>=arguments.length||GraphLoader.call(this,a)};window.SimpleGraphLoader=SimpleGraphLoader;SimpleGraphLoader.prototype=new GraphLoader;SimpleGraphLoader.prototype.h=function(a){this.constellation&&jQuery(this.constellation).unbind("initialized");GraphLoader.prototype.h.call(this,a);this.constellation&&jQuery(this.constellation).bind("initialized",{context:this},function(a){a=a.data.context;a.config.url&&a.load(a.config.url)})};
...
jQuery(c),g={},i;for(i in d){var j=d[i].attr("attr.name").replace(/[^a-zA-Z0-9]/g,"_"),m=c.find('data[key="'+i+'"]');0<m.length&&(g[j]=m.text())}b.D(c.attr("source")+":"+c.attr("target"),c.attr("source"),c.attr("target"),g)});jQuery(this).trigger("complete")};GraphMlParser.prototype.parse=GraphMlParser.prototype.parse;GraphView=function(a){0>=arguments.length||(this.config=a,this.result=this.source=this.constellation=l,this.Ka=k)};window.GraphView=GraphView;GraphView.prototype.V=q("constellation");
GraphView.prototype.getConstellation=GraphView.prototype.V;GraphView.prototype.h=function(a){this.constellation=a;this.L()};GraphView.prototype.setConstellation=GraphView.prototype.h;GraphView.prototype.rb=q("source");GraphView.prototype.getSource=GraphView.prototype.rb;GraphView.prototype.zb=function(a){this.source=a;this.L()};GraphView.prototype.setSource=GraphView.prototype.zb;GraphView.prototype.ab=function(){this.L()};GraphView.prototype.sourceChanged=GraphView.prototype.ab;
GraphView.prototype.pb=q("result");GraphView.prototype.getResult=GraphView.prototype.pb;GraphView.prototype.wb=function(a){this.result=a;this.L()};GraphView.prototype.setResult=GraphView.prototype.wb;GraphView.prototype.L=function(){if(this.Ka){this.Ka=n;var a=this;window.setTimeout(function(){var b=a.validate();a.Ka=k;b&&jQuery(a).trigger("change")},50)}};GraphView.prototype.invalidate=GraphView.prototype.L;GraphView.prototype.aa=function(){return n};GraphView.prototype.validate=GraphView.prototype.aa;
...
Layout.prototype.I=function(){for(var a=this.constellation.K(),b=0;b<a.length;b++){var c=a[b];if(c.x==l||c.y==l)c.x=10*Math.floor((100*Math.random()-50)/10),c.y=10*Math.floor((100*Math.random()-50)/10)}jQuery(this).trigger("change")};Layout.prototype.viewChanged=Layout.prototype.I;StaticLayout=function(a){0>=arguments.length||(Layout.call(this,a),this.u=l)};window.StaticLayout=StaticLayout;StaticLayout.prototype=new Layout;
StaticLayout.prototype.h=function(a){this.constellation&&jQuery(this.constellation).unbind("nodemousedown").unbind("mouseup");Layout.prototype.h.call(this,a);this.constellation&&jQuery(this.constellation).bind("nodemousedown",{context:this},function(a){a.data.context.O(a)}).bind("mouseup",{context:this},function(a){a.data.context.Da(a)})};StaticLayout.prototype.setConstellation=StaticLayout.prototype.h;
...
RoamerLayout.prototype.Na=function(a){return a.x!=l||a.y!=l};function v(a){if(0>=a.length)return l;for(var b=0,c=0,d=0;d<a.length;d++)var e=a[d],b=b+e.x,c=c+e.y;return{x:b/a.length,y:c/a.length}}NodeRenderer=function(a,b,c){this.constellation=a;Node.call(this,b,c);this.data.classes||(this.data.classes=[]);this.y=this.x=l;this.ay=this.ax=this.vy=this.vx=0};window.NodeRenderer=NodeRenderer;NodeRenderer.prototype=new Node;NodeRenderer.prototype.v={};
NodeRenderer.prototype.e=function(a){return this.constellation.e("node",this.data.classes,a,this.data,this.v)};NodeRenderer.prototype.getStyle=NodeRenderer.prototype.e;NodeRenderer.prototype.addClass=function(a){0>jQuery.inArray(a,this.data.classes)&&this.data.classes.push(a)};NodeRenderer.prototype.addClass=NodeRenderer.prototype.addClass;NodeRenderer.prototype.hasClass=function(a){return 0<=jQuery.inArray(a,this.data.classes)};NodeRenderer.prototype.hasClass=NodeRenderer.prototype.hasClass;
NodeRenderer.prototype.removeClass=function(a){for(var b;0<=(b=jQuery.inArray(a,this.data.classes));)this.data.classes.splice(b,1)};NodeRenderer.prototype.removeClass=NodeRenderer.prototype.removeClass;NodeRenderer.prototype.create=o();NodeRenderer.prototype.create=NodeRenderer.prototype.create;NodeRenderer.prototype.m=o();NodeRenderer.prototype.draw=NodeRenderer.prototype.m;NodeRenderer.prototype.position=o();NodeRenderer.prototype.position=NodeRenderer.prototype.position;
NodeRenderer.prototype.o=o();NodeRenderer.prototype.destroy=NodeRenderer.prototype.o;DefaultNodeRenderer=function(a,b,c){NodeRenderer.call(this,a,b,c)};window.DefaultNodeRenderer=DefaultNodeRenderer;DefaultNodeRenderer.prototype=new NodeRenderer;DefaultNodeRenderer.prototype.v={};
...
RoamerEdgeRenderer.prototype.m=function(){jQuery(this.a.line).attr("x1",this.tailNode.x).attr("y1",this.tailNode.y).attr("x2",this.headNode.x).attr("y2",this.headNode.y).css("stroke",this.e("edge_line_color")).css("strokeWidth",this.e("edge_line_thickness")).css("display","inline")};RoamerEdgeRenderer.prototype.draw=RoamerEdgeRenderer.prototype.m;RoamerEdgeRenderer.prototype.o=function(){jQuery(this.a.line).remove()};RoamerEdgeRenderer.prototype.destroy=RoamerEdgeRenderer.prototype.o;
Constellation=function(a,b){this.config=jQuery.extend(k,this.bb,a);this.ma=b?b:this.v;this.f=[];this.d=[];this.svg=l;this.C=this.B=this.R=this.U=0;this.l=1;this.rotation=0;this.k={};this.$=this.H=this.p=this.c=l};window.Constellation=Constellation;Constellation.Db={};

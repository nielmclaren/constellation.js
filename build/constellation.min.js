...
Graph.prototype.Ba=function(a,b){var c=this.u(a);c?c.data=b:h("Failed to update edge. Edge does not exist. id="+a);return c};Graph.prototype.updateEdge=Graph.prototype.Ba;Graph.prototype.Da=function(a,b,c,d,e,g){var e=4<arguments.length?e:s,g=5<arguments.length?g:s,f=this.u(a);f?f.data=e?jQuery.extend(g,f.data,d):d:f=this.D(a,b,c,d);return f};Graph.prototype.upsertEdge=Graph.prototype.Da;GraphLoader=function(a){0>=arguments.length||(this.config=a,this.parser=this.constellation=q)};
...
GraphView.prototype.sb=v("result");GraphView.prototype.getResult=GraphView.prototype.sb;GraphView.prototype.Ib=function(a){this.result=a;this.O()};GraphView.prototype.setResult=GraphView.prototype.Ib;GraphView.prototype.O=function(){if(this.Fa){this.Fa=s;var a=this;window.setTimeout(function(){var b=a.validate();a.Fa=p;b&&jQuery(a).trigger("change")},50)}};GraphView.prototype.invalidate=GraphView.prototype.O;GraphView.prototype.ea=function(){return s};GraphView.prototype.validate=GraphView.prototype.ea;
...
DirectGraphView.prototype.ea=function(){var a,b=this.result.$(),c=this.result.Z(),d=this.source.N(),e=this.source.ha();for(a=0;a<e.length;a++)index=c.indexOf(e[a].id),0<=index&&(edge=this.result.u(e[a].id),edge.data=e[a].data,c.splice(index,1),e.splice(a,1),a--);for(a=0;a<d.length;a++)index=b.indexOf(d[a].id),0<=index&&(node=this.result.k(d[a].id),node.data=d[a].data,b.splice(index,1),d.splice(a,1),a--);for(a=0;a<c.length;a++)this.result.da(c[a]);for(a=0;a<b.length;a++)this.result.removeNode(b[a]);
for(a=0;a<d.length;a++)b=d[a],this.result.F(b.id,b.data);for(a=0;a<e.length;a++)d=e[a],this.result.D(d.id,d.tailNode.id,d.headNode.id,d.data);return p};DirectGraphView.prototype.validate=DirectGraphView.prototype.ea;TreeGraphView=function(a){0>=arguments.length||(GraphView.call(this,a),this.G=q,this.Aa=s,this.ga=1)};window.TreeGraphView=TreeGraphView;TreeGraphView.prototype=new GraphView;
TreeGraphView.prototype.j=function(a){this.constellation&&jQuery(this.constellation).unbind("nodeselect");GraphView.prototype.j.call(this,a);this.constellation&&jQuery(this.constellation).bind("nodeselect",{context:this},function(a){a.data.context.Sa()})};TreeGraphView.prototype.setConstellation=TreeGraphView.prototype.j;TreeGraphView.prototype.Sa=function(){this.Aa=p;this.G=this.constellation.Ma();this.O()};TreeGraphView.prototype.selectedNodeHandler=TreeGraphView.prototype.Sa;
TreeGraphView.prototype.ea=function(){var a,b,c=this.config.startDepth?this.config.startDepth:2,d=this.config.depth?this.config.depth:3,e=this.config.delay?this.config.delay:1E3;this.Aa&&(this.ga=c);if(a=this.source.k(this.G)){a.data.depth=0;var g=this.result.$(),f=this.result.Z(),i=[a],c=[];b={};var j=[a];for(b[this.G]={R:this.ga,ka:0};0<j.length;){var k=j.shift(),o=b[k.id];if(0<o.R){var n=k.edges;for(a=0;a<n.length;a++){var m=n[a],l;l=m.tailNode.id==k.id?m.headNode:m.tailNode;var r=b[l.id];if((!r||
r.R<o.R-1)&&1<o.R)r=o.R-1,l.data.depth=o.ka+1,i.push(l),j.push(l),r={R:r,ka:o.ka+1},b[l.id]=r;0>jQuery.inArray(m,c)&&r&&(m.data.depth=o.ka,c.push(m))}}}for(a=0;a<c.length;a++)b=f.indexOf(c[a].id),0<=b&&(m=this.result.u(c[a].id),m.data=c[a].data,m.o(),f.splice(b,1),c.splice(a,1),a--);for(a=0;a<i.length;a++)b=g.indexOf(i[a].id),0<=b&&(node=this.result.k(i[a].id),node.data=i[a].data,node.o(),g.splice(b,1),i.splice(a,1),a--);for(a=0;a<f.length;a++)b=f[a],jQuery(this.source.k(b)).unbind("dataChange",this.Mb),
this.result.da(b);for(a=0;a<g.length;a++)f=g[a],jQuery(this.source.k(f)).unbind("dataChange",this.Ob),this.result.removeNode(f);for(a=0;a<i.length;a++)g=i[a],f=this.result.F(g.id,jQuery.extend({},g.data)),jQuery(g).bind("dataChange",{context:this,result:f},this.Ha);for(a=0;a<c.length;a++)i=c[a],g=this.result.D(i.id,i.tailNode.id,i.headNode.id,jQuery.extend({},i.data)),jQuery(i).bind("dataChange",{context:this,result:g},this.Ha);this.Aa=s;if(this.ga<d){clearTimeout(this.wb);var u=this;this.wb=setTimeout(function(){u.ga++;
u.O()},e)}return p}};TreeGraphView.prototype.validate=TreeGraphView.prototype.ea;TreeGraphView.prototype.Ha=function(a){a.data.result.data=a.target.data;a.data.result.p()};Layout=function(a){0>=arguments.length||(this.config=a)};window.Layout=Layout;Layout.prototype.Y=v("constellation");Layout.prototype.getConstellation=Layout.prototype.Y;Layout.prototype.j=function(a){this.constellation=a};Layout.prototype.setConstellation=Layout.prototype.j;
...
StaticLayout.prototype.j=function(a){this.constellation&&jQuery(this.constellation).unbind("nodemousedown").unbind("mouseup");Layout.prototype.j.call(this,a);this.constellation&&jQuery(this.constellation).bind("nodemousedown",{context:this},function(a){a.data.context.ya(a)}).bind("mouseup",{context:this},function(a){a.data.context.va(a)})};StaticLayout.prototype.setConstellation=StaticLayout.prototype.j;
...
StaticLayout.prototype.step=function(){for(var a in this.constellation.f){var b=this.constellation.f[a];if(b.ca){var c=b.i,d=b.ca,e=this.constellation.A(c.pageX)-b.wa,b=this.constellation.B(0,c.pageY)-b.xa;d.x=this.constellation.T(e,b);d.y=this.constellation.U(e,b)}}jQuery(this).trigger("change");this.C&&clearTimeout(this.C);this.C=setTimeout(function(a){return function(){a.step()}}(this),40)};RoamerLayout=function(a){0>=arguments.length||(Layout.call(this,a),this.C=q,this.ma=[])};
window.RoamerLayout=RoamerLayout;RoamerLayout.prototype=new Layout;RoamerLayout.prototype.j=function(a){this.constellation&&(jQuery(this.constellation).unbind("nodeAdded"),this.C&&clearTimeout(this.C));Layout.prototype.j.call(this,a);this.constellation&&(jQuery(this.constellation).bind("nodeAdded",{context:this},function(a,c){a.data.context.ma.push(c)}),this.step())};RoamerLayout.prototype.setConstellation=RoamerLayout.prototype.j;RoamerLayout.prototype.M=t();RoamerLayout.prototype.viewChanged=RoamerLayout.prototype.M;
RoamerLayout.prototype.step=function(){var a=this.config,b=a.scrollRate?a.scrollRate:0.1,c=a.baseEdgeLength?a.baseEdgeLength:100,d=a.attractionFactor?a.attractionFactor:0.2,e=a.repulsionFactor?a.repulsionFactor:0.2,g=a.accelerationLimit?a.accelerationLimit:15,a=a.dampingConstant?a.dampingConstant:0.3;0<this.ma.length&&(this.setNodeInitialPositions(this.ma),this.ma=[]);for(var f=this.constellation.La(),i=-b*(f.x+f.width/2),b=-b*(f.y+f.height/2),f=this.constellation.N(),j=0;j<f.length;j++)for(var k=
...
d>g&&(c.ax=c.ax/d*g,c.ay=c.ay/d*g),c.ax-=c.vx*a,c.ay-=c.vy*a,c.vx+=c.ax,c.vy+=c.ay,c.x+=c.vx+i,c.y+=c.vy+b,c.ax=0,c.ay=0;for(var G in this.constellation.f)i=this.constellation.f[G],i.ca&&(c=i.i,g=i.ca,a=this.constellation.A(c.pageX)-i.wa,i=this.constellation.B(0,c.pageY)-i.xa,g.x=this.constellation.T(a,i),g.y=this.constellation.U(a,i));jQuery(this).trigger("change");this.C&&clearTimeout(this.C);this.C=setTimeout(function(a){return function(){a.step()}}(this),40)};
RoamerLayout.prototype.Gb=function(a){for(var b=0;b<a.length;b++)this.setNodeInitialPosition(a[b])};RoamerLayout.prototype.setNodeInitialPositions=RoamerLayout.prototype.Gb;RoamerLayout.prototype.Fb=function(a){var b=0,c=0,d=a.pa().filter(this.Ja),e=w(d);1<d.length?(b=e.x,c=e.y):0<d.length&&(c=d[0],b=c.pa().filter(this.Ja),0<b.length?(b=w(b),d={x:c.x-b.x,y:c.y-b.y},e=Math.sqrt(d.x*d.x+d.y*d.y),b=c.x+50*d.x/e,c=c.y+50*d.y/e):(b=c.x,c=c.y));a.x=b+Math.random()-0.5;a.y=c+Math.random()-0.5};
RoamerLayout.prototype.setNodeInitialPosition=RoamerLayout.prototype.Fb;RoamerLayout.prototype.Ja=function(a){return a.x!=q||a.y!=q};function w(a){if(0>=a.length)return q;for(var b=0,c=0,d=0;d<a.length;d++)var e=a[d],b=b+e.x,c=c+e.y;return{x:b/a.length,y:c/a.length}}NodeRenderer=function(a,b,c){this.constellation=a;this.classes=[];Node.call(this,b,c);this.o();this.y=this.x=q;this.ay=this.ax=this.vy=this.vx=0};window.NodeRenderer=NodeRenderer;NodeRenderer.prototype=new Node;
...
NodeRenderer.prototype.create=NodeRenderer.prototype.create;NodeRenderer.prototype.p=t();NodeRenderer.prototype.draw=NodeRenderer.prototype.p;NodeRenderer.prototype.position=t();NodeRenderer.prototype.position=NodeRenderer.prototype.position;NodeRenderer.prototype.H=t();NodeRenderer.prototype.destroy=NodeRenderer.prototype.H;DefaultNodeRenderer=function(a,b,c){NodeRenderer.call(this,a,b,c);this.za=this.ta=this.Oa=this.Na=this.K=this.label=q};window.DefaultNodeRenderer=DefaultNodeRenderer;
...
break;default:this.constellation.error("Unexpected value for node labelPosition property. value="+this.c("labelPosition"));case "center":labelPosition={x:0,y:0}}a.change(this.a.label,labelPosition);var b=this.a.label.getBBox(),f=this.c("leftIconWidth"),i=this.c("leftIconHeight"),j=b.x-5-f,k=b.y+b.height/2-i/2,o=this.c("leftIconUrl");o!=this.ta?(this.ta==q?this.a.J=a.vb(this.a.group,j,k,f,i,o):o==q?(a.remove(this.a.J),this.a.J=q):a.change(this.a.J,{"xlink:href":o,x:j,y:k,width:f,height:i}),this.ta=
o):a.change(this.a.J,{x:j,y:k,width:f,height:i});var j=this.c("rightIconWidth"),o=this.c("rightIconHeight"),n=b.x+b.width+5,m=b.y+b.height/2-o/2,l=this.c("rightIconUrl");l!=this.za?(this.za==q?this.a.L=a.vb(this.a.group,n,m,j,o,l):l==q?(a.remove(this.a.L),this.a.L=q):a.change(this.a.L,{"xlink:href":l,x:n,y:m,width:j,height:o}),this.za=l):a.change(this.a.L,{x:n,y:m,width:j,height:o});n=jQuery(this.a.Qa);this.c("labelBoxEnabled")&&0<b.width&&0<b.height?(l=b.y,this.a.J&&k<l&&(l=k),this.a.L&&m<l&&(l=
...
GephiNodeRenderer.prototype.create=function(){var a=this.constellation.svg,b=a.group(this.constellation.qa(),{display:"none"}),c=a.group(b);this.a={group:b,sa:c,z:a.circle(c,0,0,this.size/2,{strokeWidth:3}),label:a.text(b,0,0,"",{style:"-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-o-user-select: none;user-select: none;",fontFamily:"Verdana",fontSize:12,fontWeight:"normal",fill:"#333333",textAnchor:"left",dy:".35em"})};jQuery(this.a.group).bind("mouseover",{context:this},
...
DefaultEdgeRenderer.prototype.create=function(){var a=this.constellation.svg,b=a.group(this.constellation.Ka());this.a={group:b,line:a.line(b,0,0,10,0,{display:"none",stroke:this.c("edgeLineColor"),strokeWidth:this.c("edgeLineThickness")}),K:a.title(b,"")};jQuery(this.a.line).bind("mouseover",{context:this},function(a){a.data.context.constellation.edgemouseoverHandler(a,a.data.context)}).bind("mouseout",{context:this},function(a){a.data.context.constellation.edgemouseoutHandler(a,a.data.context)}).bind("mousedown",
...
Constellation=function(a,b){this.config=jQuery.extend(p,this.$a,a);this.la=b?this.Ia.concat(b):this.Ia;this.h=[];this.e=[];this.svg=q;this.t=this.s=this.S=this.V=0;this.l=1;this.rotation=0;this.f={};this.P=this.G=this.n=this.d=q};window.Constellation=Constellation;Constellation.Nb={};
...
this.q=b.find("div.container");this.q.svg({onLoad:function(a){return function(b){a.svg=b;a.debug("SVG initialized");x(a);a.Ga=a.svg.group();a.na=a.svg.group(a.Ga);a.ja=a.svg.group(a.Ga);y(a)}}(this)});this.Pa();this.Xa(new Graph);a=this.config.graphLoaderClass;this.Ta(a?new a(this.config.graphLoader):q);a=this.config.graphParserClass;this.Ua(a?new a(this.config.graphParser):q);a=this.config.graphViewClass;this.Va(a?new a(this.config.graphView):q);a=this.config.layoutClass;this.Wa(a?new a(this.config.layout):
...
Constellation.prototype.$a={id:"constellation",graphLoaderClass:SimpleGraphLoader,graphLoader:{},graphParserClass:JsonGraphParser,graphParser:{},graphViewClass:DirectGraphView,graphView:{},layoutClass:RoamerLayout,layout:{},zoomSlider:{display:"auto",orientation:"vertical",min:0.2,max:2,value:1,step:0.05}};Constellation.prototype.Ia=[["node",{rendererClass:DefaultNodeRenderer}],["edge",{rendererClass:DefaultEdgeRenderer}]];Constellation.prototype.ob=v("ba");Constellation.prototype.getModel=Constellation.prototype.ob;
Constellation.prototype.Xa=function(a){this.debug("Set model:",a);this.ba=a;this.w&&this.w.setGraph(this.ba);this.m&&this.m.setSource(this.ba);this.ua()};Constellation.prototype.setModel=Constellation.prototype.Xa;Constellation.prototype.mb=v("m");Constellation.prototype.getGraphView=Constellation.prototype.mb;
Constellation.prototype.Va=function(a){this.debug("Set graph view:",a);this.m&&(this.m.setConstellation(q),this.m.setSource(q),this.m.setResult(q),jQuery(this.m).unbind("change"));if(this.m=a)this.m.setConstellation(this),this.m.setSource(this.ba),this.m.setResult(this),jQuery(this.m).bind("change",{context:this},function(a){a.data.context.M()})};Constellation.prototype.setGraphView=Constellation.prototype.Va;Constellation.prototype.kb=v("v");Constellation.prototype.getGraphLoader=Constellation.prototype.kb;
Constellation.prototype.Ta=function(a){this.debug("Set graph loader:",a);this.v&&(this.v.setConstellation(q),this.v.setParser(q));if(this.v=a)this.v.setConstellation(this),this.v.setParser(this.w)};Constellation.prototype.setGraphLoader=Constellation.prototype.Ta;Constellation.prototype.lb=v("w");Constellation.prototype.getGraphParser=Constellation.prototype.lb;
Constellation.prototype.Ua=function(a){this.debug("Set graph parser:",a);this.w&&(this.v&&this.v.setParser(q),this.w.setGraph(q),jQuery(this.w).unbind("complete"));if(this.w=a)this.v&&this.v.setParser(this.w),this.w.setGraph(this.ba),jQuery(this.w).bind("complete",{context:this},function(a){a.data.context.ua()})};Constellation.prototype.setGraphParser=Constellation.prototype.Ua;Constellation.prototype.nb=v("I");Constellation.prototype.getLayout=Constellation.prototype.nb;
Constellation.prototype.Wa=function(a){this.debug("Set layout:",a);this.I&&(this.I.setConstellation(q),jQuery(this.I).unbind("change"));if(this.I=a)this.I.setConstellation(this),jQuery(this.I).bind("change",{context:this},function(a){a.data.context.Ra()})};Constellation.prototype.setLayout=Constellation.prototype.Wa;Constellation.prototype.qa=v("ja");Constellation.prototype.getNodeContainer=Constellation.prototype.qa;Constellation.prototype.Ka=v("na");Constellation.prototype.getEdgeContainer=Constellation.prototype.Ka;
Constellation.prototype.Ma=v("G");Constellation.prototype.getSelectedNodeId=Constellation.prototype.Ma;Constellation.prototype.Kb=function(a){this.debug("Set selected node ID:",a);this.P&&(this.P=q,jQuery(this).trigger("edgeselect"));this.G!=a&&(this.G=a,jQuery(this).trigger("nodeselect",this.G))};Constellation.prototype.setSelectedNodeId=Constellation.prototype.Kb;Constellation.prototype.tb=v("P");Constellation.prototype.getSelectedEdgeId=Constellation.prototype.tb;
Constellation.prototype.Jb=function(a){this.G&&(this.G=q,jQuery(this).trigger("nodeselect"));this.P!=a&&(this.P=a,jQuery(this).trigger("edgeselect",this.P))};Constellation.prototype.setSelectedEdgeId=Constellation.prototype.Jb;Constellation.prototype.La=function(){return this.ja.getBBox()};Constellation.prototype.getRendererBounds=Constellation.prototype.La;
...
Constellation.prototype.k=function(a){for(var b=0;b<this.h.length;b++)if(this.h[b].id==a)return this.h[b];return q};Constellation.prototype.getNode=Constellation.prototype.k;Constellation.prototype.N=function(){return this.h.concat()};Constellation.prototype.getNodes=Constellation.prototype.N;Constellation.prototype.$=function(){return this.h.map(function(a){return a.id})};Constellation.prototype.getNodeIds=Constellation.prototype.$;Constellation.prototype.ra=function(){return this.h.length};
Constellation.prototype.getNodeLength=Constellation.prototype.ra;Constellation.prototype.removeNode=function(a){this.debug("Remove node:",a);for(var b=0;b<this.h.length;b++){var c=this.h[b];if(c.id==a){c.destroy(c);this.h.splice(b,1);jQuery(this).trigger("nodeRemoved",c);return}}h("Failed to remove node. Node does not exist. id="+a)};Constellation.prototype.removeNode=Constellation.prototype.removeNode;
Constellation.prototype.Ca=function(a,b){var c=this.k(a);c?c.data=b:h("Failed to update node. Node does not exist. id="+a);return c};Constellation.prototype.updateNode=Constellation.prototype.Ca;Constellation.prototype.Ea=function(a,b,c,d){var c=2<arguments.length?c:s,d=3<arguments.length?d:s,e=this.k(a);e?e.data=c?jQuery.extend(d,e.data,b):b:e=this.F(a,b);return e};Constellation.prototype.upsertNode=Constellation.prototype.Ea;
...
a);return a};Constellation.prototype.addEdge=Constellation.prototype.D;Constellation.prototype.u=function(a){for(var b=0;b<this.e.length;b++)if(this.e[b].id==a)return this.e[b];return q};Constellation.prototype.getEdge=Constellation.prototype.u;Constellation.prototype.Z=function(){return this.e.map(function(a){return a.id})};Constellation.prototype.getEdgeIds=Constellation.prototype.Z;Constellation.prototype.ha=function(){return this.e.concat()};Constellation.prototype.getEdges=Constellation.prototype.ha;
Constellation.prototype.oa=function(){return this.e.length};Constellation.prototype.getEdgeLength=Constellation.prototype.oa;
...
Constellation.prototype.removeEdge=Constellation.prototype.da;Constellation.prototype.Ba=function(a,b){var c=this.u(a);c?c.data=b:h("Failed to update edge. Edge does not exist. id="+a);return c};Constellation.prototype.updateEdge=Constellation.prototype.Ba;Constellation.prototype.Da=function(a,b,c,d,e,g){var e=4<arguments.length?e:s,g=5<arguments.length?g:s,f=this.u(a);f?f.data=e?jQuery.extend(g,f.data,d):d:f=this.D(a,b,c,d);return f};Constellation.prototype.upsertEdge=Constellation.prototype.Da;
Constellation.prototype.ua=function(){this.debug("Model changed");this.m&&this.m.Ya();jQuery(this).trigger("modelchanged")};Constellation.prototype.modelChanged=Constellation.prototype.ua;Constellation.prototype.M=function(){this.debug("View changed");this.I&&this.I.viewChanged();jQuery(this).trigger("viewchanged")};Constellation.prototype.viewChanged=Constellation.prototype.M;Constellation.prototype.Ra=function(){this.p()};Constellation.prototype.layoutChanged=Constellation.prototype.Ra;
Constellation.prototype.p=function(){var a;x(this);var b=this.h;for(a=0;a<b.length;a++)b[a].position();b=this.e;for(a=0;a<b.length;a++)b[a].position()};function x(a){a.V=a.q.width();a.S=a.q.height();y(a);jQuery(a).trigger("viewportchange")}function y(a){a.q.button&&a.q.slider&&jQuery("#"+a.config.id+" .zoomSlider").slider("option","value",a.l);jQuery(a.Ga).attr("transform","translate("+(a.V/2-a.s)+","+(a.S/2-a.t)+")scale("+a.l+","+a.l+")rotate("+180*a.rotation/Math.PI+")")}
Constellation.prototype.ia=v("l");Constellation.prototype.getZoomScale=Constellation.prototype.ia;Constellation.prototype.Q=function(a){this.l=a;y(this);jQuery(this).trigger("viewportchange")};Constellation.prototype.setZoomScale=Constellation.prototype.Q;Constellation.prototype.T=function(a,b){return(a-this.V/2+this.s)/this.l*Math.cos(-this.rotation)-(b-this.S/2+this.t)/this.l*Math.sin(-this.rotation)};Constellation.prototype.viewportToWorldX=Constellation.prototype.T;
...
Constellation.prototype.va=function(a){var b=this.f._mouse;b&&(b.i=a);b&&F(a,b)&&jQuery(this).trigger("click");A(this);delete this.f._mouse;this.d==b&&(this.d=this.n,this.n=q);this.n==b&&(this.n=q);jQuery(this).trigger("mouseup")};
function A(a){var b=a.d,c=a.n;if(b){if(c){var d=a.W(c.x,c.y)-a.W(b.x,b.y),e=a.X(c.x,c.y)-a.X(b.x,b.y),g=Math.sqrt(d*d+e*e),f=a.A(c.i.pageX)-a.A(b.i.pageX),i=a.B(0,c.i.pageY)-a.B(0,b.i.pageY),c=Math.sqrt(f*f+i*i),d=Math.atan2(i,f)-Math.atan2(e,d);d>Math.PI&&(d-=2*Math.PI);d<-Math.PI&&(d=2*Math.PI+d);a.l=a.l*c/g;a.rotation+=d;a.s=a.s+a.W(b.x,b.y)-a.A(b.i.pageX);a.t=a.t+a.X(b.x,b.y)-a.B(0,b.i.pageY);0!=d&&a.p()}else a.s=a.s+a.W(b.x,b.y)-a.A(b.i.pageX),a.t=a.t+a.X(b.x,b.y)-a.B(0,b.i.pageY);y(a);jQuery(a).trigger("viewportchange")}}
Constellation.prototype.c=function(a,b,c,d,e){var g,f;if(d&&void 0!==d[c])return d[c];if(b&&0<b.length)for(d=this.la.length;0<d;d--){f=this.la[d-1];g=f[0];var i=jQuery.inArray(".",g),j=0>i?g:g.substr(0,i);if(!(""!=j&&j!=a)){i=0>i?[]:g.substr(i+1).split(".");j=p;for(g=0;g<i.length;g++)if(0>jQuery.inArray(i[g],b)){j=s;break}if(j&&void 0!==f[1][c])return f[1][c]}}for(d=this.la.length;0<d;d--)if((f=this.la[d-1])&&1<f.length&&f[0]==a&&void 0!==f[1][c])return f[1][c];return e?e[c]:void 0};
Constellation.prototype.getStyle=Constellation.prototype.c;Constellation.prototype.fa=function(a){jQuery(this.ja).children().last()[0]!=a.renderer.group&&jQuery(a.renderer.group).insertAfter(jQuery(this.ja).children().last())};Constellation.prototype.arrangeNodeFront=Constellation.prototype.fa;Constellation.prototype.Za=function(a){jQuery(this.na).children().last()[0]!=a.renderer.group&&jQuery(a.renderer.group).insertAfter(jQuery(this.na).children().last())};

...
Constellation.prototype.Ta=function(a){this.debug("Set graph view:",a);this.m&&(this.m.setConstellation(q),this.m.setSource(q),this.m.setResult(q),jQuery(this.m).unbind("change"));if(this.m=a)this.m.setConstellation(this),this.m.setSource(this.ba),this.m.setResult(this),jQuery(this.m).bind("change",{context:this},function(a){a.data.context.L()})};Constellation.prototype.setGraphView=Constellation.prototype.Ta;Constellation.prototype.ib=v("v");Constellation.prototype.getGraphLoader=Constellation.prototype.ib;

...
Graph.prototype.Ca=function(a,b,c,d){var c=2<arguments.length?c:s,d=3<arguments.length?d:s,e=this.k(a);e?e.data=c?jQuery.extend(d,e.data,b):b:e=this.D(a,b);return e};Graph.prototype.upsertNode=Graph.prototype.Ca;
Graph.prototype.C=function(a,b,c,d){this.t(a)&&h("Failed to add edge. Edge already exists. id="+a);var e=this.k(b);e||h("Failed to add edge. Tail node does not exist. id="+b);(b=this.k(c))||h("Failed to add edge. Head node does not exist. id="+c);a=new Edge(a,e,b,d);this.e.push(a);e.edges.push(a);b.edges.push(a);return a};Graph.prototype.addEdge=Graph.prototype.C;Graph.prototype.t=function(a){for(var b=0;b<this.e.length;b++)if(this.e[b].id==a)return this.e[b];return q};Graph.prototype.getEdge=Graph.prototype.t;
...
Graph.prototype.za=function(a,b){var c=this.t(a);c?c.data=b:h("Failed to update edge. Edge does not exist. id="+a);return c};Graph.prototype.updateEdge=Graph.prototype.za;Graph.prototype.Ba=function(a,b,c,d,e,g){var e=4<arguments.length?e:s,g=5<arguments.length?g:s,f=this.t(a);f?f.data=e?jQuery.extend(g,f.data,d):d:f=this.C(a,b,c,d);return f};Graph.prototype.upsertEdge=Graph.prototype.Ba;GraphLoader=function(a){0>=arguments.length||(this.config=a,this.parser=this.constellation=q)};
...
GraphMlParser.prototype.parse=function(a){a instanceof jQuery||(a=jQuery(a));var b=this.graph,c={};a.find('key[for="node"]').each(function(a,b){b=jQuery(b);c[b.attr("id")]=b});var d={};a.find('key[for="edge"]').each(function(a,b){b=jQuery(b);d[b.attr("id")]=b});a.find("node").each(function(a,d){var d=jQuery(d),f={},i;for(i in c){var j=c[i].attr("attr.name").replace(/[^a-zA-Z0-9]/g,"_"),k=d.find('data[key="'+i+'"]');0<k.length&&(f[j]=k.text())}b.D(d.attr("id"),f)});a.find("edge").each(function(a,c){var c=
jQuery(c),f={},i;for(i in d){var j=d[i].attr("attr.name").replace(/[^a-zA-Z0-9]/g,"_"),k=c.find('data[key="'+i+'"]');0<k.length&&(f[j]=k.text())}b.C(c.attr("source")+":"+c.attr("target"),c.attr("source"),c.attr("target"),f)});jQuery(this).trigger("complete")};GraphMlParser.prototype.parse=GraphMlParser.prototype.parse;GraphView=function(a){0>=arguments.length||(this.config=a,this.result=this.source=this.constellation=q,this.Da=p)};window.GraphView=GraphView;GraphView.prototype.Y=v("constellation");
...
DirectGraphView.prototype.ea=function(){var a,b=this.result.$(),c=this.result.Z(),d=this.source.N(),e=this.source.ga();for(a=0;a<e.length;a++)index=c.indexOf(e[a].id),0<=index&&(edge=this.result.t(e[a].id),edge.data=e[a].data,c.splice(index,1),e.splice(a,1),a--);for(a=0;a<d.length;a++)index=b.indexOf(d[a].id),0<=index&&(node=this.result.k(d[a].id),node.data=d[a].data,b.splice(index,1),d.splice(a,1),a--);for(a=0;a<c.length;a++)this.result.da(c[a]);for(a=0;a<b.length;a++)this.result.removeNode(b[a]);
for(a=0;a<d.length;a++)b=d[a],this.result.D(b.id,b.data);for(a=0;a<e.length;a++)d=e[a],this.result.C(d.id,d.tailNode.id,d.headNode.id,d.data);return p};DirectGraphView.prototype.validate=DirectGraphView.prototype.ea;TreeGraphView=function(a){0>=arguments.length||(GraphView.call(this,a),this.F=q,this.ya=s,this.fa=1)};window.TreeGraphView=TreeGraphView;TreeGraphView.prototype=new GraphView;
TreeGraphView.prototype.j=function(a){this.constellation&&jQuery(this.constellation).unbind("nodeselect");GraphView.prototype.j.call(this,a);this.constellation&&jQuery(this.constellation).bind("nodeselect",{context:this},function(a){a.data.context.Qa()})};TreeGraphView.prototype.setConstellation=TreeGraphView.prototype.j;TreeGraphView.prototype.Qa=function(){this.ya=p;this.F=this.constellation.Ka();this.O()};TreeGraphView.prototype.selectedNodeHandler=TreeGraphView.prototype.Qa;
TreeGraphView.prototype.ea=function(){var a,b,c=this.config.startDepth?this.config.startDepth:2,d=this.config.depth?this.config.depth:3,e=this.config.delay?this.config.delay:1E3;this.ya&&(this.fa=c);if(a=this.source.k(this.F)){a.data.depth=0;var g=this.result.$(),f=this.result.Z(),i=[a],c=[];b={};var j=[a];for(b[this.F]={R:this.fa,ja:0};0<j.length;){var k=j.shift(),o=b[k.id];if(0<o.R){var n=k.edges;for(a=0;a<n.length;a++){var m=n[a],l;l=m.tailNode.id==k.id?m.headNode:m.tailNode;var r=b[l.id];if((!r||
r.R<o.R-1)&&1<o.R)r=o.R-1,l.data.depth=o.ja+1,i.push(l),j.push(l),r={R:r,ja:o.ja+1},b[l.id]=r;0>jQuery.inArray(m,c)&&r&&(m.data.depth=o.ja,c.push(m))}}}for(a=0;a<c.length;a++)b=f.indexOf(c[a].id),0<=b&&(m=this.result.t(c[a].id),m.data=c[a].data,m.o(),f.splice(b,1),c.splice(a,1),a--);for(a=0;a<i.length;a++)b=g.indexOf(i[a].id),0<=b&&(node=this.result.k(i[a].id),node.data=i[a].data,node.o(),g.splice(b,1),i.splice(a,1),a--);for(a=0;a<f.length;a++)b=f[a],jQuery(this.source.k(b)).unbind("dataChange",this.Kb),
this.result.da(b);for(a=0;a<g.length;a++)f=g[a],jQuery(this.source.k(f)).unbind("dataChange",this.Mb),this.result.removeNode(f);for(a=0;a<i.length;a++)g=i[a],f=this.result.D(g.id,jQuery.extend({},g.data)),jQuery(g).bind("dataChange",{context:this,result:f},this.Fa);for(a=0;a<c.length;a++)i=c[a],g=this.result.C(i.id,i.tailNode.id,i.headNode.id,jQuery.extend({},i.data)),jQuery(i).bind("dataChange",{context:this,result:g},this.Fa);this.ya=s;if(this.fa<d){clearTimeout(this.ub);var u=this;this.ub=setTimeout(function(){u.fa++;
...
Layout.prototype.K=function(){for(var a=this.constellation.N(),b=0;b<a.length;b++){var c=a[b];if(c.x==q||c.y==q)c.x=10*Math.floor((100*Math.random()-50)/10),c.y=10*Math.floor((100*Math.random()-50)/10)}jQuery(this).trigger("change")};Layout.prototype.viewChanged=Layout.prototype.K;StaticLayout=function(a){0>=arguments.length||(Layout.call(this,a),this.B=q)};window.StaticLayout=StaticLayout;StaticLayout.prototype=new Layout;
...
StaticLayout.prototype.K=function(){for(var a=this.constellation.N(),b=0;b<a.length;b++){var c=a[b];if(c.x==q||c.y==q)c.x=c.data.x?c.data.x:(Math.random()-0.5)*this.constellation.V,c.y=c.data.y?c.data.y:(Math.random()-0.5)*this.constellation.S}jQuery(this).trigger("change")};StaticLayout.prototype.viewChanged=StaticLayout.prototype.K;StaticLayout.prototype.wa=function(){this.step()};StaticLayout.prototype.ta=function(){this.B&&clearInterval(this.B)};
StaticLayout.prototype.step=function(){for(var a in this.constellation.f){var b=this.constellation.f[a];if(b.ca){var c=b.i,d=b.ca,e=this.constellation.z(c.pageX)-b.ua,b=this.constellation.A(0,c.pageY)-b.va;d.x=this.constellation.T(e,b);d.y=this.constellation.U(e,b)}}jQuery(this).trigger("change");this.B&&clearTimeout(this.B);this.B=setTimeout(function(a){return function(){a.step()}}(this),40)};RoamerLayout=function(a){0>=arguments.length||(Layout.call(this,a),this.B=q,this.la=[])};
window.RoamerLayout=RoamerLayout;RoamerLayout.prototype=new Layout;RoamerLayout.prototype.j=function(a){this.constellation&&(jQuery(this.constellation).unbind("nodeAdded"),this.B&&clearTimeout(this.B));Layout.prototype.j.call(this,a);this.constellation&&(jQuery(this.constellation).bind("nodeAdded",{context:this},function(a,c){a.data.context.la.push(c)}),this.step())};RoamerLayout.prototype.setConstellation=RoamerLayout.prototype.j;RoamerLayout.prototype.K=t();RoamerLayout.prototype.viewChanged=RoamerLayout.prototype.K;
...
d>g&&(c.ax=c.ax/d*g,c.ay=c.ay/d*g),c.ax-=c.vx*a,c.ay-=c.vy*a,c.vx+=c.ax,c.vy+=c.ay,c.x+=c.vx+i,c.y+=c.vy+b,c.ax=0,c.ay=0;for(var H in this.constellation.f)i=this.constellation.f[H],i.ca&&(c=i.i,g=i.ca,a=this.constellation.z(c.pageX)-i.ua,i=this.constellation.A(0,c.pageY)-i.va,g.x=this.constellation.T(a,i),g.y=this.constellation.U(a,i));jQuery(this).trigger("change");this.B&&clearTimeout(this.B);this.B=setTimeout(function(a){return function(){a.step()}}(this),40)};
...
NodeRenderer.prototype.create=NodeRenderer.prototype.create;NodeRenderer.prototype.p=t();NodeRenderer.prototype.draw=NodeRenderer.prototype.p;NodeRenderer.prototype.position=t();NodeRenderer.prototype.position=NodeRenderer.prototype.position;NodeRenderer.prototype.G=t();NodeRenderer.prototype.destroy=NodeRenderer.prototype.G;DefaultNodeRenderer=function(a,b,c){NodeRenderer.call(this,a,b,c);this.xa=this.ra=this.Ma=this.La=this.J=this.label=q};window.DefaultNodeRenderer=DefaultNodeRenderer;
...
DefaultNodeRenderer.prototype.p=function(){var a=this.constellation.svg;jQuery(this.a.group).css("display","inline");var b={fill:this.c("graphicFillColor"),stroke:this.c("graphicLineColor")},c=this.c("label"),d=this.c("tooltip"),e=this.c("graphicSize"),g=this.c("graphicShape");if(this.La!=g)switch(this.a.w&&(jQuery(this.a.w).remove(),this.a.w=q),g){case "pentagon":break;case "square":this.a.w=a.rect(this.a.qa,-e/2,-e/2,e,e,b);break;case "diamond":break;case "triangle":break;case "circle":this.a.w=
a.circle(this.a.qa,0,0,e/2,b);break;default:h("Failed to draw node graphic. Unknown shape. shape='"+g+"'")}else{if(this.Ma!=e)switch(g){case "pentagon":break;case "square":b.x=-e/2;b.y=-e/2;b.width=e;b.height=e;break;case "diamond":break;case "triangle":break;case "circle":b.r=e/2;break;default:h("Failed to draw node graphic. Unknown shape. shape='"+g+"'")}a.change(this.a.w,b)}this.label!=c&&jQuery(this.a.label).contents().remove().end().append(c);a.change(this.a.label,{fontFamily:this.c("labelFontFamily"),
fontSize:this.c("labelFontSize"),fontStyle:this.c("labelFontStyle"),fontWeight:this.c("labelFontWeight"),fill:this.c("labelFontColor")});var f=this.a.w?this.a.w.getBBox():{width:0,height:0},b=this.a.label.getBBox();switch(this.c("labelPosition")){case "top":labelPosition={x:0,y:-f.height/2-5-3-b.height/2};break;case "right":labelPosition={x:f.width/2+5+b.width/2+8,y:0};break;case "bottom":labelPosition={x:0,y:f.height/2+8+b.height/2};break;case "left":labelPosition={x:-f.width/2-5-8-b.width/2,y:0};
break;default:this.constellation.error("Unexpected value for node labelPosition property. value="+this.c("labelPosition"));case "center":labelPosition={x:0,y:0}}a.change(this.a.label,labelPosition);var b=this.a.label.getBBox(),f=this.c("leftIconWidth"),i=this.c("leftIconHeight"),j=b.x-5-f,k=b.y+b.height/2-i/2,o=this.c("leftIconUrl");o!=this.ra?(this.ra==q?this.a.I=a.tb(this.a.group,j,k,f,i,o):o==q?(a.remove(this.a.I),this.a.I=q):a.change(this.a.I,{"xlink:href":o,x:j,y:k,width:f,height:i}),this.ra=
o):a.change(this.a.I,{x:j,y:k,width:f,height:i});var j=this.c("rightIconWidth"),o=this.c("rightIconHeight"),n=b.x+b.width+5,m=b.y+b.height/2-o/2,l=this.c("rightIconUrl");l!=this.xa?(this.xa==q?this.a.M=a.tb(this.a.group,n,m,j,o,l):l==q?(a.remove(this.a.M),this.a.M=q):a.change(this.a.M,{"xlink:href":l,x:n,y:m,width:j,height:o}),this.xa=l):a.change(this.a.M,{x:n,y:m,width:j,height:o});n=jQuery(this.a.Oa);this.c("labelBoxEnabled")&&0<b.width&&0<b.height?(l=b.y,this.a.I&&k<l&&(l=k),this.a.M&&m<l&&(l=
m),k=b.height,this.a.I&&i>k&&(k=i),this.a.M&&o>k&&(k=o),n.css("display","inline"),n.attr("x",b.x-(this.a.I?f+5:0)-8),n.attr("y",l-3),n.attr("width",b.width+(this.a.I?f+5:0)+(this.a.M?j+5:0)+16),n.attr("height",k+6),b=this.c("labelBoxCornerRadius"),n.attr("rx",b),n.attr("ry",b),a.change(this.a.Oa,{fill:this.c("labelBoxFillColor"),stroke:this.c("labelBoxLineColor")})):n.css("display","none");this.J!=d&&jQuery(this.a.J).contents().remove().end().append(d);jQuery(this.a.group).css("cursor",this.c("cursor"));
this.position();this.label=c;this.J=d;this.Ma=e;this.La=g};DefaultNodeRenderer.prototype.draw=DefaultNodeRenderer.prototype.p;DefaultNodeRenderer.prototype.position=function(){jQuery(this.a.group).attr("transform","translate("+this.x+","+this.y+")rotate("+180*-this.constellation.rotation/Math.PI+")")};DefaultNodeRenderer.prototype.position=DefaultNodeRenderer.prototype.position;DefaultNodeRenderer.prototype.G=function(){jQuery(this.a.group).remove();this.a=q};
DefaultNodeRenderer.prototype.destroy=DefaultNodeRenderer.prototype.G;GephiNodeRenderer=function(a,b,c){NodeRenderer.call(this,a,b,c);this.label="";this.size=0};window.GephiNodeRenderer=GephiNodeRenderer;GephiNodeRenderer.prototype=new NodeRenderer;GephiNodeRenderer.prototype.defaultStyles={label:"",r:255,g:255,b:255,size:5};
GephiNodeRenderer.prototype.create=function(){var a=this.constellation.svg,b=a.group(this.constellation.oa(),{display:"none"}),c=a.group(b);this.a={group:b,qa:c,w:a.circle(c,0,0,this.size/2,{strokeWidth:3}),label:a.text(b,0,0,"",{style:"-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-o-user-select: none;user-select: none;",fontFamily:"Verdana",fontSize:12,fontWeight:"normal",fill:"#333333",textAnchor:"left",dy:".35em"})};jQuery(this.a.group).bind("mouseover",{context:this},
...
EdgeRenderer.prototype.dataChanged=EdgeRenderer.prototype.o;EdgeRenderer.prototype.create=t();EdgeRenderer.prototype.create=EdgeRenderer.prototype.create;EdgeRenderer.prototype.p=t();EdgeRenderer.prototype.draw=EdgeRenderer.prototype.p;EdgeRenderer.prototype.G=t();EdgeRenderer.prototype.destroy=EdgeRenderer.prototype.G;DefaultEdgeRenderer=function(a,b,c,d,e){EdgeRenderer.call(this,a,b,c,d,e);this.J=q};window.DefaultEdgeRenderer=DefaultEdgeRenderer;DefaultEdgeRenderer.prototype=new EdgeRenderer;
...
DefaultEdgeRenderer.prototype.create=function(){var a=this.constellation.svg,b=a.group(this.constellation.Ia());this.a={group:b,line:a.line(b,0,0,10,0,{display:"none",stroke:this.c("edgeLineColor"),strokeWidth:this.c("edgeLineThickness")}),J:a.title(b,"")};jQuery(this.a.line).bind("mouseover",{context:this},function(a){a.data.context.constellation.edgemouseoverHandler(a,a.data.context)}).bind("mouseout",{context:this},function(a){a.data.context.constellation.edgemouseoutHandler(a,a.data.context)}).bind("mousedown",
...
DefaultEdgeRenderer.prototype.draw=DefaultEdgeRenderer.prototype.p;DefaultEdgeRenderer.prototype.G=function(){jQuery(this.a.line).remove()};DefaultEdgeRenderer.prototype.destroy=DefaultEdgeRenderer.prototype.G;Constellation=function(a,b){this.config=jQuery.extend(p,this.Xa,a);this.ka=b?this.Ga.concat(b):this.Ga;this.h=[];this.e=[];this.svg=q;this.s=this.q=this.S=this.V=0;this.l=1;this.rotation=0;this.f={};this.P=this.F=this.n=this.d=q};window.Constellation=Constellation;Constellation.Lb={};
...
q);"createTouch"in document?this.L.bind("touchstart",{context:this},function(a){var b=a.data.context;a.stopPropagation();a.preventDefault();for(var e=0;e<a.originalEvent.changedTouches.length;e++){var g=a.originalEvent.changedTouches[e],f=b.f["_"+g.identifier]={aa:p,i:g,pageX:g.pageX,pageY:g.pageY,timestamp:(new Date).getTime()},i=b.z(g.pageX),g=b.A(0,g.pageY);f.x=b.T(i,g);f.y=b.U(i,g);b.d?b.n||(b.n=f):b.d=f}jQuery(b).trigger("touchstart")}).bind("touchmove",{context:this},function(a){var b=a.data.context;
a.stopPropagation();a.preventDefault();A(b);jQuery(b).trigger("touchmove")}).bind("touchend",{context:this},function(a){var b=a.data.context;a.preventDefault();A(b);for(var e=0;e<a.originalEvent.changedTouches.length;e++)var g=a.originalEvent.changedTouches[e],f=b.f["_"+g.identifier];for(e=0;e<a.originalEvent.changedTouches.length;e++)g=a.originalEvent.changedTouches[e],f=b.f["_"+g.identifier],delete b.f["_"+g.identifier],b.d==f&&(b.d=b.n,b.n=q,b.d&&(b.d.pageX=b.d.i.pageX,b.d.pageY=b.d.i.pageY,b.d.q=
b.q,b.d.s=b.s,b.d.l=b.l)),b.n==f&&(b.n=q,b.d&&(b.d.pageX=b.d.i.pageX,b.d.pageY=b.d.i.pageY,b.d.q=b.q,b.d.s=b.s,b.d.l=b.l));jQuery(b).trigger("touchend")}).bind("touchcancel",{context:this},function(a){var b=a.data.context;a.preventDefault();for(var e=0;e<a.originalEvent.changedTouches.length;e++)delete b.f["_"+a.originalEvent.changedTouches[e].identifier];jQuery(b).trigger("touchcancel")}):(jQuery(document).mousemove({context:this},function(a){var b=a.data.context,e=b.f._mouse;e&&(e.i=a);A(b)}).mouseup({context:this},
function(a){a.data.context.ta(a)}),this.L.find("svg").mousedown({context:this},function(a){var b=a.data.context,e=b.f._mouse={aa:s,i:a,pageX:a.pageX,pageY:a.pageY},g=b.z(a.pageX),a=b.A(0,a.pageY);e.x=b.T(g,a);e.y=b.U(g,a);b.d?b.n||(b.n=e):b.d=e;jQuery(b).trigger("mousedown")}).click({context:this},function(a){a.stopPropagation();a.preventDefault()}),jQuery(this.canvas).mousewheel({context:this},function(a,b){var e=a.data.context;a.preventDefault();e.Q(e.ha()+0.1*b);jQuery(e).trigger("mousewheel")}));
...
var b=this.config.zoomSlider;jQuery("#"+a+" .zoomInButton").button({icons:{primary:"ui-icon-plus"},text:s}).bind("click",{context:this},function(a){a=a.data.context;a.Q(Math.min(b.max,a.ha()+b.step))});jQuery("#"+a+" .zoomOutButton").button({icons:{primary:"ui-icon-minus"},text:s}).bind("click",{context:this},function(a){a=a.data.context;a.Q(Math.max(b.min,a.ha()-b.step))});jQuery("#"+a+" .zoomSlider").slider(b).bind("slide",{context:this},function(a,b){a.data.context.Q(b.value)});switch(b.display){case "on":case "yes":case "true":case p:case 1:break;
case "auto":"createTouch"in document&&jQuery("#"+a+" .zoomControls").hide();break;default:jQuery("#"+a+" .zoomControls").hide()}this.Q(b.value)};Constellation.prototype.initZoomControls=Constellation.prototype.Na;
...
Constellation.prototype.Va=function(a){this.debug("Set model:",a);this.ba=a;this.v&&this.v.setGraph(this.ba);this.m&&this.m.setSource(this.ba);this.sa()};Constellation.prototype.setModel=Constellation.prototype.Va;Constellation.prototype.kb=v("m");Constellation.prototype.getGraphView=Constellation.prototype.kb;
Constellation.prototype.Ta=function(a){this.debug("Set graph view:",a);this.m&&(this.m.setConstellation(q),this.m.setSource(q),this.m.setResult(q),jQuery(this.m).unbind("change"));if(this.m=a)this.m.setConstellation(this),this.m.setSource(this.ba),this.m.setResult(this),jQuery(this.m).bind("change",{context:this},function(a){a.data.context.K()})};Constellation.prototype.setGraphView=Constellation.prototype.Ta;Constellation.prototype.ib=v("u");Constellation.prototype.getGraphLoader=Constellation.prototype.ib;
Constellation.prototype.Ra=function(a){this.debug("Set graph loader:",a);this.u&&(this.u.setConstellation(q),this.u.setParser(q));if(this.u=a)this.u.setConstellation(this),this.u.setParser(this.v)};Constellation.prototype.setGraphLoader=Constellation.prototype.Ra;Constellation.prototype.jb=v("v");Constellation.prototype.getGraphParser=Constellation.prototype.jb;
Constellation.prototype.Sa=function(a){this.debug("Set graph parser:",a);this.v&&(this.u&&this.u.setParser(q),this.v.setGraph(q),jQuery(this.v).unbind("complete"));if(this.v=a)this.u&&this.u.setParser(this.v),this.v.setGraph(this.ba),jQuery(this.v).bind("complete",{context:this},function(a){a.data.context.sa()})};Constellation.prototype.setGraphParser=Constellation.prototype.Sa;Constellation.prototype.lb=v("H");Constellation.prototype.getLayout=Constellation.prototype.lb;
Constellation.prototype.Ua=function(a){this.debug("Set layout:",a);this.H&&(this.H.setConstellation(q),jQuery(this.H).unbind("change"));if(this.H=a)this.H.setConstellation(this),jQuery(this.H).bind("change",{context:this},function(a){a.data.context.Pa()})};Constellation.prototype.setLayout=Constellation.prototype.Ua;Constellation.prototype.oa=v("ia");Constellation.prototype.getNodeContainer=Constellation.prototype.oa;Constellation.prototype.Ia=v("Za");Constellation.prototype.getEdgeContainer=Constellation.prototype.Ia;
Constellation.prototype.Ka=v("F");Constellation.prototype.getSelectedNodeId=Constellation.prototype.Ka;Constellation.prototype.Ib=function(a){this.debug("Set selected node ID:",a);this.P&&(this.P=q,jQuery(this).trigger("edgeselect"));this.F!=a&&(this.F=a,jQuery(this).trigger("nodeselect",this.F))};Constellation.prototype.setSelectedNodeId=Constellation.prototype.Ib;Constellation.prototype.rb=v("P");Constellation.prototype.getSelectedEdgeId=Constellation.prototype.rb;
Constellation.prototype.Hb=function(a){this.F&&(this.F=q,jQuery(this).trigger("nodeselect"));this.P!=a&&(this.P=a,jQuery(this).trigger("edgeselect",this.P))};Constellation.prototype.setSelectedEdgeId=Constellation.prototype.Hb;Constellation.prototype.Ja=function(){return this.ia.getBBox()};Constellation.prototype.getRendererBounds=Constellation.prototype.Ja;
...
Constellation.prototype.Aa=function(a,b){var c=this.k(a);c?c.data=b:h("Failed to update node. Node does not exist. id="+a);return c};Constellation.prototype.updateNode=Constellation.prototype.Aa;Constellation.prototype.Ca=function(a,b,c,d){var c=2<arguments.length?c:s,d=3<arguments.length?d:s,e=this.k(a);e?e.data=c?jQuery.extend(d,e.data,b):b:e=this.D(a,b);return e};Constellation.prototype.upsertNode=Constellation.prototype.Ca;
Constellation.prototype.C=function(a,b,c,d){this.debug("Add edge:",a);this.t(a)&&h("Failed to add edge. Edge already exists. id="+a);var e=this.k(b);e||h("Failed to add edge. Tail node does not exist. id="+b);(b=this.k(c))||h("Failed to add edge. Head node does not exist. id="+c);a=new (this.c("edge",d&&d["class"]?d["class"].split(/\s/):[],"rendererClass",d,{rendererClass:DefaultNodeRenderer}))(this,a,e,b,d);a.create();a.draw();this.e.push(a);e.edges.push(a);b.edges.push(a);jQuery(this).trigger("edgeAdded",
a);return a};Constellation.prototype.addEdge=Constellation.prototype.C;Constellation.prototype.t=function(a){for(var b=0;b<this.e.length;b++)if(this.e[b].id==a)return this.e[b];return q};Constellation.prototype.getEdge=Constellation.prototype.t;Constellation.prototype.Z=function(){return this.e.map(function(a){return a.id})};Constellation.prototype.getEdgeIds=Constellation.prototype.Z;Constellation.prototype.ga=function(){return this.e.concat()};Constellation.prototype.getEdges=Constellation.prototype.ga;
...
Constellation.prototype.removeEdge=Constellation.prototype.da;Constellation.prototype.za=function(a,b){var c=this.t(a);c?c.data=b:h("Failed to update edge. Edge does not exist. id="+a);return c};Constellation.prototype.updateEdge=Constellation.prototype.za;Constellation.prototype.Ba=function(a,b,c,d,e,g){var e=4<arguments.length?e:s,g=5<arguments.length?g:s,f=this.t(a);f?f.data=e?jQuery.extend(g,f.data,d):d:f=this.C(a,b,c,d);return f};Constellation.prototype.upsertEdge=Constellation.prototype.Ba;
Constellation.prototype.sa=function(){this.debug("Model changed");this.m&&this.m.Wa();jQuery(this).trigger("modelchanged")};Constellation.prototype.modelChanged=Constellation.prototype.sa;Constellation.prototype.K=function(){this.debug("View changed");this.H&&this.H.K();jQuery(this).trigger("viewchanged")};Constellation.prototype.viewChanged=Constellation.prototype.K;Constellation.prototype.Pa=function(){this.p()};Constellation.prototype.layoutChanged=Constellation.prototype.Pa;
Constellation.prototype.p=function(){var a;x(this);var b=this.h;for(a=0;a<b.length;a++)b[a].position();b=this.e;for(a=0;a<b.length;a++)b[a].draw()};function x(a){a.V=a.L.width();a.S=a.L.height();y(a)}function y(a){jQuery("#"+a.config.id+" .zoomSlider").slider("option","value",a.l);jQuery(a.Ea).attr("transform","translate("+(a.V/2-a.q)+","+(a.S/2-a.s)+")scale("+a.l+","+a.l+")rotate("+180*a.rotation/Math.PI+")")}Constellation.prototype.ha=v("l");Constellation.prototype.getZoomScale=Constellation.prototype.ha;
Constellation.prototype.Q=function(a){this.l=a;y(this)};Constellation.prototype.setZoomScale=Constellation.prototype.Q;Constellation.prototype.T=function(a,b){return(a-this.V/2+this.q)/this.l*Math.cos(-this.rotation)-(b-this.S/2+this.s)/this.l*Math.sin(-this.rotation)};Constellation.prototype.viewportToWorldX=Constellation.prototype.T;Constellation.prototype.U=function(a,b){return(a-this.V/2+this.q)/this.l*Math.sin(-this.rotation)+(b-this.S/2+this.s)/this.l*Math.cos(-this.rotation)};
Constellation.prototype.viewportToWorldY=Constellation.prototype.U;Constellation.prototype.W=function(a,b){return(a*Math.cos(this.rotation)-b*Math.sin(this.rotation))*this.l+this.V/2-this.q};Constellation.prototype.worldToViewportX=Constellation.prototype.W;Constellation.prototype.X=function(a,b){return(a*Math.sin(this.rotation)+b*Math.cos(this.rotation))*this.l+this.S/2-this.s};Constellation.prototype.worldToViewportY=Constellation.prototype.X;Constellation.prototype.z=function(a){return a-this.L.offset().left};
Constellation.prototype.pageToViewportX=Constellation.prototype.z;Constellation.prototype.A=function(a,b){return b-this.L.offset().top};Constellation.prototype.pageToViewportY=Constellation.prototype.A;Constellation.prototype.yb=function(a,b){a.stopPropagation();a.preventDefault();B(this,b);jQuery(this).trigger("nodemouseover",b.id)};Constellation.prototype.nodemouseoverHandler=Constellation.prototype.yb;
Constellation.prototype.xb=function(a,b){a.stopPropagation();a.preventDefault();jQuery(this).trigger("nodemouseout",b.id)};Constellation.prototype.nodemouseoutHandler=Constellation.prototype.xb;Constellation.prototype.wa=function(a,b){a.stopPropagation();a.preventDefault();B(this,b);var c=this.f._mouse={aa:s,ca:b,i:a,pageX:a.pageX,pageY:a.pageY,timestamp:(new Date).getTime()},d=this.z(a.pageX),e=this.A(0,a.pageY);c.ua=this.T(d,e)-b.x;c.va=this.U(d,e)-b.y;jQuery(this).trigger("nodemousedown",b.id)};
Constellation.prototype.nodemousedownHandler=Constellation.prototype.wa;Constellation.prototype.zb=function(a,b){a.stopPropagation();a.preventDefault();jQuery(this).trigger("nodemouseup",b.id)};Constellation.prototype.nodemouseupHandler=Constellation.prototype.zb;Constellation.prototype.wb=function(a,b){a.stopPropagation();a.preventDefault();var c=this.f._mouse;c&&G(a,c)&&jQuery(this).trigger("nodeclick",b.id);delete this.f._mouse};Constellation.prototype.nodeclickHandler=Constellation.prototype.wb;
Constellation.prototype.Bb=function(a,b){a.stopPropagation();a.preventDefault();B(this,b);for(var c=0;c<a.originalEvent.changedTouches.length;c++){var d=a.originalEvent.changedTouches[c];this.f["_"+d.identifier]={aa:p,ca:b,ua:this.z(d.pageX)-this.W(b.x,b.y),va:this.A(0,d.pageY)-this.X(b.x,b.y),i:d,pageX:d.pageX,pageY:d.pageY,timestamp:(new Date).getTime()}}jQuery(this).trigger("nodetouchstart",b.id)};Constellation.prototype.nodetouchstartHandler=Constellation.prototype.Bb;
...
function A(a){var b=a.d,c=a.n;if(b){if(c){var d=a.W(c.x,c.y)-a.W(b.x,b.y),e=a.X(c.x,c.y)-a.X(b.x,b.y),g=Math.sqrt(d*d+e*e),f=a.z(c.i.pageX)-a.z(b.i.pageX),i=a.A(0,c.i.pageY)-a.A(0,b.i.pageY),c=Math.sqrt(f*f+i*i),d=Math.atan2(i,f)-Math.atan2(e,d);d>Math.PI&&(d-=2*Math.PI);d<-Math.PI&&(d=2*Math.PI+d);a.l=a.l*c/g;a.rotation+=d;a.q=a.q+a.W(b.x,b.y)-a.z(b.i.pageX);a.s=a.s+a.X(b.x,b.y)-a.A(0,b.i.pageY);0!=d&&a.p()}else a.q=a.q+a.W(b.x,b.y)-a.z(b.i.pageX),a.s=a.s+a.X(b.x,b.y)-a.A(0,b.i.pageY);y(a)}}

...
for(a=0;a<d.length;a++)b=d[a],this.result.D(b.id,b.data);for(a=0;a<e.length;a++)d=e[a],this.result.C(d.id,d.tailNode.id,d.headNode.id,d.data);return p};DirectGraphView.prototype.validate=DirectGraphView.prototype.ea;TreeGraphView=function(a){0>=arguments.length||(GraphView.call(this,a),this.G=q,this.ya=s,this.fa=1)};window.TreeGraphView=TreeGraphView;TreeGraphView.prototype=new GraphView;
...
Layout.prototype.L=function(){for(var a=this.constellation.N(),b=0;b<a.length;b++){var c=a[b];if(c.x==q||c.y==q)c.x=10*Math.floor((100*Math.random()-50)/10),c.y=10*Math.floor((100*Math.random()-50)/10)}jQuery(this).trigger("change")};Layout.prototype.viewChanged=Layout.prototype.L;StaticLayout=function(a){0>=arguments.length||(Layout.call(this,a),this.B=q)};window.StaticLayout=StaticLayout;StaticLayout.prototype=new Layout;
...
StaticLayout.prototype.L=function(){for(var a=this.constellation.N(),b=0;b<a.length;b++){var c=a[b];if(c.x==q||c.y==q)c.x=c.data.x?c.data.x:(Math.random()-0.5)*this.constellation.V,c.y=c.data.y?c.data.y:(Math.random()-0.5)*this.constellation.S}jQuery(this).trigger("change")};StaticLayout.prototype.viewChanged=StaticLayout.prototype.L;StaticLayout.prototype.wa=function(){this.step()};StaticLayout.prototype.ta=function(){this.B&&clearInterval(this.B)};
...
o):a.change(this.a.J,{x:j,y:k,width:f,height:i});var j=this.c("rightIconWidth"),o=this.c("rightIconHeight"),n=b.x+b.width+5,m=b.y+b.height/2-o/2,l=this.c("rightIconUrl");l!=this.xa?(this.xa==q?this.a.M=a.tb(this.a.group,n,m,j,o,l):l==q?(a.remove(this.a.M),this.a.M=q):a.change(this.a.M,{"xlink:href":l,x:n,y:m,width:j,height:o}),this.xa=l):a.change(this.a.M,{x:n,y:m,width:j,height:o});n=jQuery(this.a.Oa);this.c("labelBoxEnabled")&&0<b.width&&0<b.height?(l=b.y,this.a.J&&k<l&&(l=k),this.a.M&&m<l&&(l=
m),k=b.height,this.a.J&&i>k&&(k=i),this.a.M&&o>k&&(k=o),n.css("display","inline"),n.attr("x",b.x-(this.a.J?f+5:0)-8),n.attr("y",l-3),n.attr("width",b.width+(this.a.J?f+5:0)+(this.a.M?j+5:0)+16),n.attr("height",k+6),b=this.c("labelBoxCornerRadius"),n.attr("rx",b),n.attr("ry",b),a.change(this.a.Oa,{fill:this.c("labelBoxFillColor"),stroke:this.c("labelBoxLineColor")})):n.css("display","none");this.K!=d&&jQuery(this.a.K).contents().remove().end().append(d);jQuery(this.a.group).css("cursor",this.c("cursor"));
...
Constellation.prototype.Ta=function(a){this.debug("Set graph view:",a);this.m&&(this.m.setConstellation(q),this.m.setSource(q),this.m.setResult(q),jQuery(this.m).unbind("change"));if(this.m=a)this.m.setConstellation(this),this.m.setSource(this.ba),this.m.setResult(this),jQuery(this.m).bind("change",{context:this},function(a){a.data.context.L()})};Constellation.prototype.setGraphView=Constellation.prototype.Ta;Constellation.prototype.ib=v("u");Constellation.prototype.getGraphLoader=Constellation.prototype.ib;
...
Constellation.prototype.Sa=function(a){this.debug("Set graph parser:",a);this.v&&(this.u&&this.u.setParser(q),this.v.setGraph(q),jQuery(this.v).unbind("complete"));if(this.v=a)this.u&&this.u.setParser(this.v),this.v.setGraph(this.ba),jQuery(this.v).bind("complete",{context:this},function(a){a.data.context.sa()})};Constellation.prototype.setGraphParser=Constellation.prototype.Sa;Constellation.prototype.lb=v("I");Constellation.prototype.getLayout=Constellation.prototype.lb;

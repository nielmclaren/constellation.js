...
Constellation.prototype.p=function(){var a;x(this);var b=this.h;for(a=0;a<b.length;a++)b[a].position();b=this.e;for(a=0;a<b.length;a++)b[a].draw()};function x(a){a.V=a.q.width();a.S=a.q.height();y(a)}function y(a){a.q.button&&a.q.slider&&jQuery("#"+a.config.id+" .zoomSlider").slider("option","value",a.l);jQuery(a.Ga).attr("transform","translate("+(a.V/2-a.s)+","+(a.S/2-a.t)+")scale("+a.l+","+a.l+")rotate("+180*a.rotation/Math.PI+")")}Constellation.prototype.ia=v("l");
Constellation.prototype.getZoomScale=Constellation.prototype.ia;Constellation.prototype.Q=function(a){this.l=a;y(this)};Constellation.prototype.setZoomScale=Constellation.prototype.Q;Constellation.prototype.T=function(a,b){return(a-this.V/2+this.s)/this.l*Math.cos(-this.rotation)-(b-this.S/2+this.t)/this.l*Math.sin(-this.rotation)};Constellation.prototype.viewportToWorldX=Constellation.prototype.T;
